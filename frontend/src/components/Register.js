            ...
            <div className="entrance__container">
                ...
                <form className="entrance__form" name="entrance-form-register" noValidate onSubmit={handleSubmit}>
                    ...
                    <input
                        ...
                        required
                    />
                    <button className="entrance__submit-button" type="submit">Зарегистрироваться</button>
                    <Link to="signin" className="entrance__link opacity-link">Уже зарегестрированы? Войти</Link>
                </form>
            </div>
        </section>
    )
